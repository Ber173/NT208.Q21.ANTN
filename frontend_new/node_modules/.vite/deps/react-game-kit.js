...
// node_modules/react-game-kit/lib/utils/audio-player.js
var require_audio_player = __commonJS({
  "node_modules/react-game-kit/lib/utils/audio-player.js"(exports) {
    "use strict";
    ...
    var AudioPlayer = (function() {
      function AudioPlayer2(url, callback) {
...
// node_modules/react-game-kit/lib/components/body.js
var require_body = __commonJS({
  "node_modules/react-game-kit/lib/components/body.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var Body = (_temp = _class = (function(_Component) {
      ...
      function Body2(props, context) {
        _classCallCheck(this, Body2);
        var _this = _possibleConstructorReturn(this, (Body2.__proto__ || Object.getPrototypeOf(Body2)).call(this, props));
        var args = props.args, children = props.children, shape = props.shape, options = _objectWithoutProperties(props, ["args", "children", "shape"]);
      ...
      _createClass(Body2, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
          var _this2 = this;
          var args = nextProps.args, children = nextProps.children, shape = nextProps.shape, options = _objectWithoutProperties(nextProps, ["args", "children", "shape"]);
...
// node_modules/react-game-kit/lib/utils/game-loop.js
var require_game_loop = __commonJS({
  "node_modules/react-game-kit/lib/utils/game-loop.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var GameLoop = (function() {
      function GameLoop2() {
        _classCallCheck(this, GameLoop2);
        this.subscribers = [];
        this.loopID = null;
        this.loop = this.loop.bind(this);
      }
      _createClass(GameLoop2, [{
        key: "loop",
        value: function loop() {
...
// node_modules/react-game-kit/lib/components/loop.js
var require_loop = __commonJS({
  "node_modules/react-game-kit/lib/components/loop.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _propTypes = require_prop_types();
    var _propTypes2 = _interopRequireDefault(_propTypes);
    var _gameLoop = require_game_loop();
    ...
    var Loop = (_temp = _class = (function(_Component) {
      _inherits(Loop2, _Component);
      function Loop2(props) {
        _classCallCheck(this, Loop2);
        var _this = _possibleConstructorReturn(this, (Loop2.__proto__ || Object.getPrototypeOf(Loop2)).call(this, props));
...
// node_modules/react-game-kit/lib/utils/key-listener.js
var require_key_listener = __commonJS({
  "node_modules/react-game-kit/lib/utils/key-listener.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var KeyListener = (function() {
      function KeyListener2() {
        _classCallCheck(this, KeyListener2);
        this.LEFT = 37;
        this.RIGHT = 39;
        this.UP = 38;
        this.DOWN = 40;
...
// node_modules/react-game-kit/lib/components/sprite.js
var require_sprite = __commonJS({
  "node_modules/react-game-kit/lib/components/sprite.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var Sprite = (_temp = _class = (function(_Component) {
      _inherits(Sprite2, _Component);
      function Sprite2(props) {
        _classCallCheck(this, Sprite2);
        var _this = _possibleConstructorReturn(this, (Sprite2.__proto__ || Object.getPrototypeOf(Sprite2)).call(this, props));
        _this.loopID = null;
        _this.tickCount = 0;
      ...
      _createClass(Sprite2, [{
        ...
        value: function animate(props) {
          var repeat = props.repeat, ticksPerFrame = props.ticksPerFrame, state = props.state, steps = props.steps;
        ...
        value: function getImageStyles() {
          var currentStep = this.state.currentStep;
          var _props = this.props, state = _props.state, tileWidth = _props.tileWidth, tileHeight = _props.tileHeight;
...
// node_modules/react-game-kit/lib/components/stage.js
var require_stage = __commonJS({
  "node_modules/react-game-kit/lib/components/stage.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var Stage = (_temp = _class = (function(_Component) {
      _inherits(Stage2, _Component);
      function Stage2(props) {
        _classCallCheck(this, Stage2);
        var _this = _possibleConstructorReturn(this, (Stage2.__proto__ || Object.getPrototypeOf(Stage2)).call(this, props));
      ...
      _createClass(Stage2, [{
        ...
        value: function getScale() {
          var _state$dimensions = _slicedToArray(this.state.dimensions, 2), vwidth = _state$dimensions[0], vheight = _state$dimensions[1];
...
// node_modules/react-game-kit/lib/components/tile-map.js
var require_tile_map = __commonJS({
  "node_modules/react-game-kit/lib/components/tile-map.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var TileMap = (_temp = _class = (function(_Component) {
      _inherits(TileMap2, _Component);
      function TileMap2() {
        _classCallCheck(this, TileMap2);
        return _possibleConstructorReturn(this, (TileMap2.__proto__ || Object.getPrototypeOf(TileMap2)).apply(this, arguments));
      }
      _createClass(TileMap2, [{
        ...
        value: function generateMap() {
          var _this2 = this;
          var _props = this.props, columns = _props.columns, layers = _props.layers, rows = _props.rows;
          var mappedLayers = [];
      ...
      renderTile: function renderTile(tile, src, styles) {
        return _react2.default.createElement("img", { style: styles, src });
      },
      rows: 9,
      src: "",
      tileSize: 64
...
// node_modules/react-game-kit/lib/components/world.js
var require_world = __commonJS({
  "node_modules/react-game-kit/lib/components/world.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var World = (_temp = _class = (function(_Component) {
      _inherits(World2, _Component);
      function World2(props) {
        _classCallCheck(this, World2);
        var _this = _possibleConstructorReturn(this, (World2.__proto__ || Object.getPrototypeOf(World2)).call(this, props));
        _this.loopID = null;
        _this.lastTime = null;
      ...
      _createClass(World2, [{
        ...
        key: "loop",
        value: function loop() {
          var currTime = 1e-3 * Date.now();
          _matterJs.Engine.update(this.engine, 1e3 / 60, this.lastTime ? currTime / this.lastTime : 1);
...
// node_modules/react-game-kit/lib/index.js
var require_lib = __commonJS({
  "node_modules/react-game-kit/lib/index.js"(exports) {
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    exports.World = exports.TileMap = exports.Stage = exports.Sprite = exports.KeyListener = exports.Loop = exports.Body = exports.AudioPlayer = void 0;
    var _audioPlayer = require_audio_player();
    var _audioPlayer2 = _interopRequireDefault(_audioPlayer);
    var _body = require_body();
    var _body2 = _interopRequireDefault(_body);
    var _loop = require_loop();
    var _loop2 = _interopRequireDefault(_loop);
    var _keyListener = require_key_listener();
    var _keyListener2 = _interopRequireDefault(_keyListener);
    var _sprite = require_sprite();
    var _sprite2 = _interopRequireDefault(_sprite);
    var _stage = require_stage();
    var _stage2 = _interopRequireDefault(_stage);
    var _tileMap = require_tile_map();
    var _tileMap2 = _interopRequireDefault(_tileMap);
    var _world = require_world();
...
//# sourceMappingURL=react-game-kit.js.map
